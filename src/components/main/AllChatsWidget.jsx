  ...
  return (
    <div className="px-4 flex justify-center">
      <div className="user-chat-container   flex items-center w-[90vw] lg:w-[50vw] h-24 border-b-2">
        {stuff.listing?.image.asset.url &&         <div className="image relative">
          <img
            onClick={() => navigate("../listings/" + stuff.listing?._id)}
          ...
          <div onClick={() =>
              ...
              } className="user-image absolute top-8 right-[-10px]">
        ...
        <div className="info ml-6 w-full">
          ...
          <div className="user-post-title-lastchat-delete flex justify-between">
            ...
            >
              ...
              {stuff.chatArray != null && <div className="last-message flex items-center space-x-1">
