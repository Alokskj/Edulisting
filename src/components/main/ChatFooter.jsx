...
const ChatFooter = () => {
    ...
    return (
        ...
        <div className="flex items-center bg-white p-2 rounded-xl relative">
            {attachmentPreview && (
                <div className="absolute w-[100px] h-[100px] bottom-16 left-0 bg-slate-50 p-2 rounded-md">
                    
                    <img src={attachmentPreview} className="overflow-hidden w-full h-full object-contain"/>
                    <div
            ...
            {isTyping && (
                <div className="absolute -top-6 left-4  w-full h-6">
                    <div className="flex gap-2 w-full h-full font-semibold text-sm text-black">
                        {`${data?.user?.displayName} is typing`}
                        <img src="/images/svgs/typing.svg" />
                    </div>
                </div>
            )}
